...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'passport_expire_date' => [
            'date' => 'Ngày hết hạn hộ chiếu sai định dạng',
        ],
        'dob' => [
            'date' => 'Ngày sinh sai định dạng',
        ],
        'personal_id_card_issue_date' => [
            'date' => 'Ngày cấp CMT/CC sai định dạng',
        ],
        'date' => [
    ...
    */
    ...
    'attributes' => [
        ...
        'sex' => 'giới tính',
        'dob' => 'ngày sinh',
        'id_code' => 'số CMND (hoặc số căn cước)',
        'id_issue_date' => 'ngày cấp CMND (hoặc thẻ căn cước)',
        'id_issue_department' => 'nơi cấp CMND (hoặc thẻ căn cước)',
        ...
        'exists' => '123132',
        'name' => 'tên',
        'maximum_team_size' => 'Tối đa thành viên'
    ],
