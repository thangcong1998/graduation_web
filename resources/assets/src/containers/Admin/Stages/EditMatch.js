    ...
    >
      ...
      {/* {match && (
                <div style={{ color: "#ff5353" }}>
                    <ClearIcon onClick={deleteCompetitor} />
                </div>
            )} */}
    </div>
  );
        ...
        <div style={{ width: "100%" }}>
          ...
          <Grid container alignItems="center">
            {match.competitors.map((cps, cpIndex) => (
              <>
                <Grid item md={5} key={cpIndex}>
                  <Droppable droppableId={cps.key}>
                    {(provided) => (
                      <div
                      ...
                      >
                        {competitionType == event_type.INDIVIDUAL &&
                          cps?.competitor && (
                            <Individual
                              competitor={cps?.competitor}
                              match={true}
                            />
                          )}
                        {competitionType == event_type.TEAM &&
                          cps?.competitor && (
                            <Team competitor={cps?.competitor} match={true} />
                          )}
      ...
      return (
        <>
          ...
          >
            ...
            <Grid item md={12}>
              <div>{/* {t("match_screen.second_date")} */}</div>
              {activeSecondDate && (
                <MuiPickersUtilsProvider
                  utils={MomentUtils}
                  locale={lang}
          ...
          <Grid container alignItems="center">
            {temp?.competitors.map((cps, cpIndex) => (
              <>
                <Grid item md={5}>
                  <Droppable droppableId={cps.key} type="competitor">
                    {(provided) => (
                      <div
                        className="characters"
                        {...provided.droppableProps}
