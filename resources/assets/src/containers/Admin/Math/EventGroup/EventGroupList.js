...
import EventGroupInput from "./EventGroupInput";
...
export default function EventGroupList(props) {
    ...
    const { columns, filterInputs } = EventGroupInput();
                    ...
                    addButton={{
                        render: (
                            <Button
                                variant="contained"
                                color="primary"
                                onClick={() => history.push("/eventGroup/create")}
                            >
                                "Thêm vòng đấu"
                            </Button>
                        ),
                ...
                <DataTable
                    ...
                    actionColumn={{
                        onEdit: {
                            display: true,
                            callback: (row) =>
                                history.push("/event_group/" + row.id),
                        },
                        onDelete: {
                            display: true,
                            action: "force",
