  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        ...
        formData.append("is_asiad", values?.is_asiad ? values?.is_asiad : "");
        formData.append(
          "is_olympic",
        ...
        formData.append(
          "result_record_time",
          values?.result_record_time ? values?.result_record_time : ""
        );
    ...
    validationSchema: Yup.object().shape({
      ...
      sport: Yup.object()
        ...
        .nullable(),
      country: Yup.object()
        .required(t("record_screen.country") + " " + t("errors.required"))
        .nullable(),
      taker_name: Yup.string()
        .required(t("record_screen.taker_name") + " " + t("errors.required"))
        .max(
          255,
      ...
      take_place: Yup.string()
        .required(t("record_screen.take_place") + " " + t("errors.required"))
        .max(
          255,
      ...
      unit: Yup.string()
        ...
        .nullable(),
      take_time: Yup.date()
        .required(t("record_screen.take_time") + " " + t("errors.required"))
        .max(
          new Date(),
          t("record_screen.take_time") + " " + t("errors.max_date_today")
        )
        .typeError(
          t("record_screen.take_time") + " " + t("errors.invalid_format")
        )
        .nullable(),
      ...
      [
        ...
        },
        {
          ...
          error:
            ...
            (formik.touched.taker_name && formik?.errors?.taker_name),
        ...
        formik.values.unit != UNIT.TIME && {
          ...
          error:
            ...
            (formik.touched.result_record && formik?.errors?.result_record),
          handleChange: (e) => formik.setFieldValue("result_record", e),
          type: "text",
          variant: "outlined",
          readOnly: false,
          grid: { xs: 12, sm: 6, md: 6 },
        },
        {
          ...
          handleChange: (e) => {
            formik.setFieldValue("result_record_time", e.target.value);
          },

          display: formik.values?.unit == UNIT.TIME,
          component: TimeInput,
          grid: { xs: 12, sm: 6, md: 6 },
        },
        {
        ...
        },
        {
          ...
          handleChange: (e) =>
            formik.setFieldValue("take_time", moment(e).format("YYYY-MM-DD")),
          type: "date",
          variant: "outlined",
          grid: { xs: 12, sm: 6, md: 6 },
        },
        ...
        },
        {
          ...
          error:
            ...
            (formik.touched.is_olympic && formik.errors?.is_olympic),
        },

        {
          ...
          error:
            ...
            (formik.touched.take_place && formik?.errors?.take_place),
  ...
  return (
    <PaperContainer>
      <div style={{ padding: 15 }}>
        <Forms
          inputs={inputs}
          valueComponent={formik?.values?.result_record_time}
        />
      </div>
      {params?.id ? (
        <Button
