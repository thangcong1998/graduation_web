...
<table style="width: 100%">
    ...
    @foreach($match_individual_list['match_individual_competitors'] as $key => $match_individual_competitor)
    <tr>
        @if($key == 0)
        ...
        @endif
        @if($key == 0)
        <td style="width: 15%; font-size: 17px; border-left: 1px solid black; border-top:1px solid black">
            {{$event['english_name']}}
        </td>
        @else
        <td style="text-align: center;width: 10%; font-size: 17px; border-left: 1px solid black">
        ...
        <td style="width: 15%; font-size: 17px; border: 1px solid black; text-align: center">
            <p>
    ...
    @foreach($match_team_list['match_event_team'] as $key => $match_event_team)
    <tr>
        @if($key == 0)
        <td style="text-align: center;width: 10%; font-size: 17px; border-left: 1px solid black; border-top:1px solid black">
            {{$index + 1}}
        ...
        @endif
        @if($key == 0)
        <td style="width: 15%;font-size: 17px; border-top: 1px solid black; border-left: 1px solid black">
