...
<div class="page">
    ...
    <div style="margin-top: 2px">
        ...
        <table class="full-width" cellspacing="0" cellpadding="0">
            ...
            @foreach($NOC as $participant)
                <tr>
                    <td rowspan="{{$participant['count']}}" style="font-size: 0.6rem">
                        {{$participant['country']['country_code_3_digits']}} - {{$participant['country']['name']}}
                    </td>
                </tr>
                @foreach($participant['participant_list'] as $competitor)
                    <tr>
