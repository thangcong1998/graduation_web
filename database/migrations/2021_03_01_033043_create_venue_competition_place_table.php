...
class CreateVenueCompetitionPlaceTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('venue_competition_place', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('venue_competition_place');
    }
}
