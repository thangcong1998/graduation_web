...
class CreateStageSubCriteriasRelationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('stage_sub_criterias_relations', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('stage_sub_criterias_relations');
    }
}
