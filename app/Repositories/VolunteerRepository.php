...
class VolunteerRepository extends  BaseRepository  implements CacheableInterface
{
    ...
    function updateExcelVolunteer(){
        try {
            ...
            $objPHPExcel = IOFactory::load('storage/documents/VolunteerForm.xlsx');
...
//                $sheet->setCellValue('B'.$rowOr,$or['abbreviation']);
            ...
            $objWriter->save('storage/documents/VolunteerForm.xlsx');
            return 'ok';
        } catch(Exception $e) {
            throw $e;
