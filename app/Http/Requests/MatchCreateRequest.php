...
class MatchCreateRequest extends FormRequest
{
    ...
    public function messages()
    {
        ...
        if (App::getLocale() === 'vi') {
            $messages = [
                'competitors.size' => 'Thiếu Vận động viên hoặc đội thi đấu',
                'competitors.required' => 'Thiếu Vận động viên hoặc đội thi đấu',
            ];
        }
        if (App::getLocale() === 'en') {
            $messages = [
                'competitors.size' => 'In short of competitor or team',
                'competitors.required' => 'In short of competitor or team',
            ];
        }
        return $messages;
    }
